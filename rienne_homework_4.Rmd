...
write.csv(dat_fin, file = "bst_oct11.csv")

p <- ggplot(data = dat_fin, aes(x=wais, y=proportions))
...
#specific to the dataset used.
    ...
    #The probability of senility increases with decreases with increased WAIS score.....(finish after assistance)
