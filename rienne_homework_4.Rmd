...
require(MASS)
q2_hl <- hoslem.test(dat_try$fit_prop, dat_try$y, g=10)
q2_hl    
...
p2 <- ggplot(data = dat_try, aes(x=y, y=prp_count))
p2 + geom_point() + geom_smooth(method = "glm", family = binomial(link = 'logit'), se= FALSE)
...
#specific to the dataset used.
    ...
    #The probability of senility increases with decreases with increased WAIS score.
